...
class SignatureMapper @Inject constructor() {
    ...
    fun toP256Signature(signature: ByteArray): PhysicalActivityOracle.P256Signature {
        ...
        val r = (seq.getObjectAt(0) as ASN1Integer).positiveValue.toByteArray()
        val s = (seq.getObjectAt(1) as ASN1Integer).positiveValue.toByteArray()
    ...
    fun toAndroidKeyAttestation(
        ipfsUploadResponse: InterPlanetaryFileSystemService.UploadResponse,
        attestationChallenge: String
    ): PhysicalActivityOracle.AndroidKeyAttestation {
