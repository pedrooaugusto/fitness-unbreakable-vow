            ...
            <div className="upkeeper-info-modal">
                {props.isSandbox && (
                    <p className="sandbox-banner">
                        <b>Sandbox mode:</b> you are interacting with the FitVow sandbox deployment (Arbitrum Sepolia), not the production version. Weeks are shortened
                        to about {weekLength} minutes, physical activity events are generated by a mock publisher, and all balances are testnet-only with no real value.<br />
