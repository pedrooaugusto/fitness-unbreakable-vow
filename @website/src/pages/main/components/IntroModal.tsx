            ...
            <div className="upkeeper-info-modal">
                {props.isSandbox && (
                    <p className="sandbox-banner">
                        <b>Sandbox mode:</b> you are interacting with the sandbox version of FitVow deployed on the <a target="_blank" style={{textDecoration: 'underline'}} href="https://docs.arbitrum.io/build-decentralized-apps/public-chains#arbitrum-sepolia"><i>Arbitrum Sepolia Testnet</i></a>, not the production version. Weeks are shortened
                ...
                <p>
                    ...
                    function on-chain to claim the enforcer share — either directly from this page with a connected wallet (e.g. MetaMask)
                    or using any other compatible Arbitrum tool. This function is permissionless — anyone can call it, and it doesn't cost anything beyond normal network gas fees.
                </p>
